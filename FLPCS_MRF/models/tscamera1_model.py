...
def trainValModelCSVIMG1(total_client,num_clients,epoch,max_acc,
    ...
    test_loader = torch.utils.data.DataLoader(CustomDataset(X_val_csv_scaled_splits[total_client-1],X_val_1_scaled_splits[total_client-1],Y_val_csv_splits[total_client-1]), batch_size=32)
