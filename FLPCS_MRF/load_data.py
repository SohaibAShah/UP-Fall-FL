...
def loadData():
    SUB = pd.read_csv('/home/syed/PhD/UP_Fall_Dataset/Sensor + Image/sensor.csv', skiprows=1)
    SUB.head()
    print(SUB.shape)
    ...
    image = '/home/syed/PhD/UP_Fall_Dataset/Sensor + Image' + '/' + 'image_' + cam + '.npy'
    name = '/home/syed/PhD/UP_Fall_Dataset/Sensor + Image' + '/' + 'name_' + cam + '.npy'
    label = '/home/syed/PhD/UP_Fall_Dataset/Sensor + Image' + '/' + 'label_' + cam + '.npy'
